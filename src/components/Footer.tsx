...
const Footer = () => {
  ...
  return (
    <footer className="bg-black dark:bg-black border-t border-primary/10">
      <div className="container mx-auto px-4 md:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div className="lg:col-span-1">
            <Link to="/" className="inline-block mb-6">
              <span className="text-xl font-heading font-bold text-foreground">VOLARIS</span>
              <span className="text-xl font-heading font-bold text-primary">SOLUTIONS</span>
            </Link>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://discord.gg/gdZXz3QR6a" target="_blank" rel="noreferrer" className="text-muted-foreground hover:text-primary transition-colors">
              ...
              <a href="mailto:volarissolutions@draftinc.xyz" className="text-muted-foreground hover:text-primary transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/services" className="text-muted-foreground hover:text-primary transition-colors flex items-center group">
              ...
              <li>
                <Link to="/services?tab=web-dev" className="text-muted-foreground hover:text-primary transition-colors flex items-center group">
                  <span>Web Development</span>
                  <ArrowRight className="ml-2 h-3 w-3 opacity-0 group-hover:opacity-100 transform group-hover:translate-x-1 transition-all" />
                </Link>
              </li>
              <li>
                <Link to="/services?tab=hosting" className="text-muted-foreground hover:text-primary transition-colors flex items-center group">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#about" className="text-muted-foreground hover:text-primary transition-colors flex items-center group">
                  <span>About Us</span>
                  <ArrowRight className="ml-2 h-3 w-3 opacity-0 group-hover:opacity-100 transform group-hover:translate-x-1 transition-all" />
                </a>
              </li>
              <li>
                <Link to="/terms-of-service" className="text-muted-foreground hover:text-primary transition-colors flex items-center group">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="mailto:support@volarissolutions.online" className="text-muted-foreground hover:text-primary transition-colors">
